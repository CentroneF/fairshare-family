...
- [x] 1.1 Add the authenticated exact-root and `/auth/**` redirect policy in middleware. — a5e33bb
- [x] 1.2 Add independent authenticated browser coverage for homepage and auth-route redirects. — a5e33bb
- [x] 1.3 Run the focused browser test and `npm run verify`. — a5e33bb

#### Manual

- [x] 1.4 Verify signed-in entry-route redirects and signed-out public/auth access in a browser. — a5e33bb
